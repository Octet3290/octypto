...
const Transactions = () =>{
    ...
    return (
        ...
        <div className="flex flex-col md:p-12 py-12 px-4">
            {currentAccount ?(
                <h3 className="text-white text-4xl text-center my-2">LATEST TRANSACTIONS</h3>
            ) : (
                <h3 className="text-white text-3xl text-center my-2">Connect your account to see some transactions</h3>
            )}
